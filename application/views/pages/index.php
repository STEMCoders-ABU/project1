            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                  <h2 class="title1">The Best Accadmic Information </h2>
                </div>
                <!-- layer 2 -->
                <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">We're In The concern Of Helping You get campus information </h1>
                </div>
                <!-- layer 3 -->
...
<div class="index-contents mt-5">
    <div class="jumbotron shadow shadow-sm">
        <h4 class="text-center text-dark text-muted">Popular Resources</h4>
